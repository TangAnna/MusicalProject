...
import com.tang.musical.FrameApplication;
import com.tang.musical.R;
import com.tang.musical.utils.QMUIDisplayHelper;
 ...
 * @date :${DATA} 17:11
 */
public abstract class TransparentToolbarDelegate extends BaseViewDelegate {
    ...
    public void create(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mToolbar = (Toolbar) View.inflate(getActivity(), R.layout.base_transparent_toolbar, null);

        //根据手机状态栏的高度设置toolbar的paddingTop值
        int statusBarHeight = QMUIDisplayHelper.getStatusBarHeight(FrameApplication.getContext());
